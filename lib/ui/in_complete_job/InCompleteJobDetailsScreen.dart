...
class InCompleteJobDetailsScreen extends StatefulWidget {
  const InCompleteJobDetailsScreen({super.key});

  @override
  State<InCompleteJobDetailsScreen> createState() => _InCompleteJobDetailsScreenState();
}

class _InCompleteJobDetailsScreenState extends State<InCompleteJobDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("InComplete Job Details", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Colors.black),),
      ),
                      ...
                      child: Align(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("InCompleted Job", style: TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.bold),),
                            SizedBox(height: 4.0,),
                          ],
                        ),
                      ),
